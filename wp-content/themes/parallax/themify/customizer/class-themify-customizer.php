...
class Themify_Customizer {
    ...
    function enqueue_fonts() {
        ...
        if (!empty($this->customizer_fonts)) {
            ...
            //Only for Open Sans Condensed the variant is required 
            $index = array_search('Open Sans Condensed', $this->customizer_fonts);
            if($index!==false){
                $this->customizer_fonts[$index] = 'Open Sans Condensed:300';
            }
    ...
    public function get_breakpoints() {
        $breakpoints = array( 'tablet' => 768, 'mobile' => 480 );
