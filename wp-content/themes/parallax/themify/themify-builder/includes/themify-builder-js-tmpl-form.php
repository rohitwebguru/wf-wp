...
$row_fields_styling = apply_filters('themify_builder_row_fields_styling', array(
	...
	array(
		...
		'meta' => array(
			...
			array('value' => 'cover_gradient', 'name' => __('Gradient', 'themify'))
                ...
                'default'=>'color',
		'option_js' => true,
		'wrap_with_class' => 'responsive-na tf-overlay-element'
	),
	array(
		'id' => 'cover_color',
		'type' => 'color',
		'label' =>'',
		'class' => 'small',
		'wrap_with_class' => 'responsive-na tf-group-element tf-group-element-color'
	),
        array(
		'id' => 'cover_gradient',
		'type' => 'gradient',
		'label' =>'',
		'wrap_with_class' => 'responsive-na tf-group-element tf-group-element-cover_gradient'
	),
        array(
	...
	array(
		...
		'label' => '',
		'class' => 'small',
		'wrap_with_class' => 'responsive-na tf-group-element tf-group-element-hover_color'
	),
           array(
		'id' => 'cover_gradient_hover',
		'type' => 'gradient',
		'label' =>'',
		'wrap_with_class' => 'responsive-na tf-group-element tf-group-element-hover_gradient'
	),
	// Font
	array(
		'type' => 'separator',
