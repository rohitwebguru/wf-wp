...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_sticky_header_acc' => $themify_customizer->accordion_start( __( 'Sticky Navigation', 'themify' ) ),
		...
		'sticky_header_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Navigation Link Font', 'themify' ),
			),
			'selector' => '.fixed-nav-bar #main-nav a',
			'prop' => 'font',
		),
		...
		'sticky_header_font_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Navigation Link Color', 'themify' ),
				'show_label' => false,
			),
		'selector' => '.fixed-nav-bar #main-nav a',
			'prop' => 'color',
		...
		'sticky_header_link_hover_font' => array(
			...
			'control' => array(
				'type'    => 'Themify_Text_Decoration_Control',
				'label'   => __( 'Navigation Link Hover', 'themify' ),
			),
			'selector' => '.fixed-nav-bar #main-nav a:hover',
			'prop' => 'font',
		),
		...
		'main_nav_dropdown_link_color' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, #nav-bar.fixed-nav-bar #main-nav ul a',
			'prop' => 'color',
		),
		...
		'main_nav_dropdown_link_hover_color' => array(
		  ...
		  'selector' => '#main-nav ul a:hover, #main-nav .current_page_item ul a:hover, #main-nav ul .current_page_item a:hover, #main-nav .current-menu-item ul a:hover, #main-nav ul .current-menu-item a:hover, #nav-bar.fixed-nav-bar #main-nav ul a:hover',
		  'prop' => 'color',
		),
