			...
			<header id="header" class="pagewidth">
				...
				<hgroup>
					...
					<?php if (is_front_page()): ?>
						<div class="wf_ext_row">
							<div class="wf_ext_header">
							<?php
								global $post;
								$ext_header_text = get_post_meta ( $post->ID, 'wonderfest_extended_header_block', true);
								echo do_shortcode ( $ext_header_text );
								//echo $ext_header_text;
							?>
							</div>
						</div>
					<?php endif; ?>
