...
<link href="<?php bloginfo('template_directory'); ?>/css/wonderfest.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/wonderfest.js"></script>
<script type="text/javascript" src="https://secure.meetup.com/4163300442513314929894/script/api/mu.btns.js?id=t0vsn58mdi99f6q5h859e1671c"></script>
<script type="text/javascript">
 $('#topSocial ul').prepend("<li id='li-meetup'><a class='twitter' title='Join our meetup!' href='http://www.meetup.com/wonderfest'><img alt='Join our meetup!' src='/wp-content/uploads/2012/03/meetup-logo.png' /></a></li>");
 $('#li-meetup').css('width','68px');
 $('#li-meetup > a').css('background','url("/wp-content/uploads/2012/03/bk_topsocial.png") no-repeat scroll 0 0 transparent');
 $('#li-meetup > a').css('width','68px');
</script>
</body>
</html>
