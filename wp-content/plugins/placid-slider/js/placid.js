/* JS For Palcid Slider WP Plugin, All JS should go here
* simplyScroll - a scroll-tastic jQuery plugin
* 1.0.4 
 *
...
$.simplyScroll.fn.extend({
	init: function() {
		...
		if (!this.o.horizontal) {
			...
			this.itemMax = this.$items.eq(1).outerWidth(true);
		...
		*/
		if(this.o.variable){
			this.itemMax=this.o.estimatedwidth;
		}
